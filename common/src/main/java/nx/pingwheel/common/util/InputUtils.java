...
public class InputUtils {
	...
	public static final KeyMapping KEY_BINDING_SETTINGS = new KeyMapping(LanguageUtils.keyOf("key", "open_settings"), InputConstants.Type.KEYBOARD, -1, SETTINGS_CATEGORY);
